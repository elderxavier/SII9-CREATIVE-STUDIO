...
<script type="text/javascript">
	...
	function openPopAddItem(id){		
		...
		$('#popAddItem #catid option[value="<?=$catid?>"]').attr("selected","selected");
		if(id){loadToEdit(id)};
	}	
	...
	function loadToEdit(id){	
		...
		$.ajax({
			...
			success: function(data) {			
				...
				$('#popAddItem #complemento').val(data.complemento);				
			...
			<div class="uiPopHolder">
				...
				<form id="formAddItem">
					...
					<div class="col1">							
						...
						<?php if($parent): ?>
						<div class="form-item">
							<label for="catid">Categorias</label>
							<select id="catid" name="catid">				
								<option value=""></option>
								<?php
								$sql = mysql_query("SELECT * from categorias WHERE parent = '".$parent."' ORDER BY pos ASC");
