...
function processAutoReplies($count = 0)
{
	while(isset($_POST["p_bfl_va_" .$count]))
	{
		...
		{
			$item = new ChatAutoReply($_POST["p_bfl_vb_" .$count."_".$icount],$_POST["p_bfl_vc_" .$count."_".$icount],$_POST["p_bfl_ve_" .$count."_".$icount],$_POST["p_bfl_vd_" .$count."_".$icount],$_POST["p_bfl_vf_" .$count."_".$icount],!empty($_POST["p_bfl_vg_" .$count."_".$icount]),$_POST["p_bfl_vh_" .$count."_".$icount],!empty($_POST["p_bfl_vi_" .$count."_".$icount]),!empty($_POST["p_bfl_vj_" .$count."_".$icount]));
...
function processTicketActions($count=0)
{
	...
	while(isset($_POST[POST_INTERN_PROCESS_TICKET_ACTIONS . "_" . $count . "_vc"]))
	{
		...
		else if($type == "AddTicketEditorReply")
		{
			...
			$Ticket->Messages[0]->Text = $Ticket->PrepareEditorReply($_POST[POST_INTERN_PROCESS_TICKET_ACTIONS . "_" . $count . "_vd_0"]);
        ...
        else if($type == "EditMessage")
        {
            ...
            $message->ApplyCustomFromPost($count,8,true,$ticket,CALLER_SYSTEM_ID);
		...
		else if($type == "CreateTicket")
		{
            ...
            $cid = $Ticket->Messages[0]->ApplyCustomFromPost($count,16);
