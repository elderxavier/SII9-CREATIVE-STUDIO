...
setcookie('lzm-credentials', $login_name . '~' . lzmBase64UrlDecodeAndHash($login_passwd));
...
<head>
    ...
    <script type="text/javascript">
        ...
        var phpDebug = <?php echo $debug; ?>;
        var debug = (phpDebug == 1) ? true : false;
        var multiServerId = <?php echo "'".$multiServerId."'"; ?>;
        ...
        $(document).ready(function() {
            ...
            var mobile_dir = lz_global_base64_url_decode(<?php echo "'".$mobile_dir."'"; ?>);
            ...
            var backgroundMode = lz_global_base64_url_decode(<?php echo "'".$backgroundMode."'"; ?>);
            ...
            var protocolMode = lz_global_base64_url_decode(<?php echo "'".$protocolMode."'"; ?>);
            var serverProtocol = '';
            if (protocolMode == '1') {
                ...
                serverProtocol = lz_global_base64_url_decode(<?php echo "'".$server_protocol."'"; ?>)
            }
            ...
            chosenProfile = {
                ...
                play_incoming_ticket_sound: lz_global_base64_url_decode(<?php echo "'".$playIncomingTicketSound."'"; ?>),
...
<audio id="sound-ticket" preload="auto">
    <source src="sounds/ticket.ogg" type="audio/ogg">
    <source src="sounds/ticket.mp3" type="audio/mpeg">
</audio>
