...
CommonToolsClass.prototype.getTicketSalutationFields = function(ticket) {
...
CommonToolsClass.prototype.createOrderedSalutationObject = function(ticket) {
    ...
    var nameArray = ticket.messages[0].fn.split(' '), language = ticket.l.toLowerCase();
...
CommonToolsClass.prototype.salutationTextExists = function(fieldName, text, language) {
    ...
    //console.log(fieldName, text, language, salutationTextPosition);
