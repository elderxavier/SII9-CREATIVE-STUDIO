...
CommonDisplayClass.prototype.createLayout = function(userStatusLogo, appOs) {
    ...
    if (this.isApp) {
        thisProfileConfigureButton.find('.ui-btn-inner').css({'padding-left':'26px'});
        iconButtonWidth = 150;
    ...
    var thisOrientationButtonCss = (this.isApp && (minWidthHeight >= 520 || this.orientation == 'horizontal')) ? {'background-image': this.addBrowserSpecificGradient('', appOs),
        position: 'absolute', left: '20px', cursor: 'pointer', border: '1px solid #ccc', 'border-radius': '1em',
