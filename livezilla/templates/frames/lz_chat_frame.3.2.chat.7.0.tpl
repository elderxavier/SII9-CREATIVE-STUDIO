	...
	<div id="lz_chat_misc">
		<table cellspacing="1" cellpadding="0" style="display:<!--translation_display-->;">
			<tr>
				...
				<td NOWRAP style="text-align:right;"><select id="lz_chat_translation_target_language" DISABLED><!--languages--></select>&nbsp;</td>
			</tr>
		</table>
		<table cellspacing="1" cellpadding="0" style="display:<!--transcript_option_display-->;">
			<tr>
				...
				<td NOWRAP style="text-align:right;"><input type="text" id="lz_chat_transcript_email">&nbsp;</td>
			</tr>
		</table>
		<br><br><br>
	</div>
