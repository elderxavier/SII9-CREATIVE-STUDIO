...
function lz_chat_set_translation(_activeId,_from,_into)
{
    ...
    if(lz_chat_data.TranslationActive != _activeId)
    {
        ...
        lz_chat_get_frame_object('lz_chat_frame.3.2.chat.7.0','lz_chat_translation_target_language').disabled = (_from == null);
        lz_chat_get_frame_object('lz_chat_frame.3.2.chat.7.0','lz_translation_service_active').checked = (_from != null);
    }
    else
        return;
    ...
    if(lz_chat_data.TranslateFrom != _from && _from != null)
    {
        ...
        for(var i=0;i<lz_chat_get_frame_object('lz_chat_frame.3.2.chat.7.0','lz_chat_translation_target_language').options.length;i++)
        {
            if(lz_chat_get_frame_object('lz_chat_frame.3.2.chat.7.0','lz_chat_translation_target_language').options[i].value==_from)
                lz_chat_get_frame_object('lz_chat_frame.3.2.chat.7.0','lz_chat_translation_target_language').selectedIndex = i;
        }
    }
...
{	
	...
	if(lz_geo_resolution_needed && lz_chat_data.ExternalUser.Session.GeoResolved.length == 7)
		_post += "&geo_lat=" + lz_global_base64_url_encode(lz_global_base64_decode(lz_chat_data.ExternalUser.Session.GeoResolved[0])) + "&geo_long=" + lz_global_base64_url_encode(lz_global_base64_decode(lz_chat_data.ExternalUser.Session.GeoResolved[1])) + "&geo_region=" + lz_global_base64_url_encode(lz_global_base64_decode(lz_chat_data.ExternalUser.Session.GeoResolved[2])) + "&geo_city=" + lz_global_base64_url_encode(lz_global_base64_decode(lz_chat_data.ExternalUser.Session.GeoResolved[3])) + "&geo_tz=" + lz_global_base64_url_encode(lz_global_base64_decode(lz_chat_data.ExternalUser.Session.GeoResolved[4])) + "&geo_ctryiso=" + lz_global_base64_url_encode(lz_global_base64_decode(lz_chat_data.ExternalUser.Session.GeoResolved[5])) + "&geo_isp=" + lz_global_base64_url_encode(lz_global_base64_decode(lz_chat_data.ExternalUser.Session.GeoResolved[6]));
...
function lz_chat_validate_group(_chat)
{
    ...
    {
        lz_chat_chat_alert(lz_chat_data.Language.ChatNotAvailable,lz_chat_get_frame_object('lz_chat_frame.3.2.lgin.1.0',''),new Function("lz_chat_tab_set_active('ticket',false);"),lz_chat_data.Language.LanguageLeaveMessageShort,true,true);
        return false;
    }
	return true;
}
