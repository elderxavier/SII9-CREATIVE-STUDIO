      ...
      <div class="container container12">
        <div id="criacao-wrapper" class="wrapper-content">
          <div class="redes-sociais">
            ...
            <a href="https://www.facebook.com/sii9creativestudio" target="_blank"><img src="imagens/ico-facebook.png" title="Facebook"></a>
  ...
  <div id="planos">
    <div class="alinhamento">
        <div id="slider-holder">
         <?php 
         $params['categ'] = 15;
         include('modules/anything_slider_banner/default.php'); 
         ?> 
        </div>
      </div>
  </div><!-- final planos -->
 ...
 <div class="container-holder">
      <div class="container container12">
        <div class="contato-main wrapper-content">
          ...
          <h6>Faça uma visita ou entrem em contato, será um prazer atende-lo(a)</h6>
            ...
            <ul>
              <li >
                ...
                <div class="info-contato">
                  Rua 1500 Lote 290 Sala 203 - Edifício Telma Regina<br/>
                  Cep: 88330-524<br/>
                  sii9@sii9.com.br<br/>
                  sii9.com.br<br/>
                  <br/>
